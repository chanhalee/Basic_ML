...
장점: output 노드가 흥분을 신중히 결정할 수 있다.
...
$$
$$  <NODE>
$$  Node.InputNode   : [1][노드명][시리얼][흥분역치][흥분여부]
$$  Node.ProcessNode : [2][노드명][시리얼][흥분역치]
$$  Node.OutputNode  : [3][노드명][시리얼][흥분역치]
$$  **
$$
$$  <EDGE>
$$  Edge.Edge        : [1][출발노드시리얼][도착노드시리얼][가중치][가중치변화량(옵션)]
$$  Edge.LoopEdge    : [2][출발노드시리얼][도착노드시리얼][가중치][가중치변화량(옵션)][루프횟수]         ** 마지막 루프횟수 누락 조심!!!!!!
